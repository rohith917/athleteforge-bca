/**
 * AthleteForge logo — gold shield + brand text.
 */
    ...
    <div className="af-logo">
      <div className="af-shield" style={{ width: shieldSize, height: shieldSize }}>
        <svg viewBox="0 0 48 56" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M24 2L44 12V28C44 40 24 54 24 54C24 54 4 40 4 28V12L24 2Z" fill="url(#shieldGrad)" stroke="#D4AF37" strokeWidth="1.5"/>

...
router.register(r'course-modules', views.CourseModuleViewSet, basename='course-modules')
router.register(r'lessons', views.LessonViewSet, basename='lessons')
router.register(r'lesson-faqs', views.LessonFAQViewSet, basename='lesson-faqs')
